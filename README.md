...
```
src/
├── application/       # Camada de Apresentação e UI (Console interativo com Scanner)
│   ├── BankConsoleApp.java
│   └── Main.java
├── model/             # Camada de Domínio (Entidades, Invariantes e Enums)
│   ├── enums/
│   │   └── TransactionType.java
│   ├── Account.java
│   ├── Transaction.java
│   └── User.java
├── service/           # Camada de Negócio e Orquestração
│   ├── AccountService.java
│   └── UserService.java
└── exceptions/        # Exceções Customizadas de Domínio (RuntimeException)
    ├── AccountNotFoundException.java
    ├── DepositLimitExceededException.java
    ...
    └── WithdrawLimitExceededException.java
```
...
1. **Clone o repositório:**
   ```bash
   git clone https://github.com/G4brielVictor/digital-banking-api.git
   ```
